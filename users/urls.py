...
urlpatterns = [
    ...
    path("send_otp_personal_id", views.send_otp_personal_id, name="send_otp_personal_id"),
    path("confirm_otp_personal_id", views.confirm_otp_personal_id, name="confirm_otp_personal_id"),
