...
urlpatterns = [
    ...
    path(
        ...
        views.validate_secondary_phone,
        name="validate_secondary_phone",
    ),
    path(
        "confirm_secondary_otp",
        views.confirm_secondary_otp,
        name="confirm_secondary_otp",
    ),
    ...
    path(
        "recover/secondary",
        views.recover_secondary_phone,
        name="recover_secondary_phone",
    ),
    path(
        "recover/confirm_secondary_otp",
        views.confirm_secondary_recovery_otp,
        name="confirm_secondary_recovery_otp",
    ),
    ...
    path(
        "accept_credential/<slug:invite_id>",
        views.accept_credential,
    ...
    path(
        "recover/initiate_deactivation",
        views.initiate_deactivation,
        name="initiate_deactivation",
    ),
    path(
        "recover/confirm_deactivation",
        views.confirm_deactivation,
        name="confirm_deactivation",
    ),
    path(
        "profile/payment_phone_number",
        payment_views.update_payment_profile_phone,
        name="update_payment_profile_phone",
    ),
    path(
        "profile/confirm_payment_otp",
        payment_views.confirm_payment_profile_otp,
        name="confirm_payment_profile_otp",
    ),
    path(
        "fetch_payment_phone_numbers",
        payment_views.FetchPhoneNumbers.as_view(),
        name="fetch_payment_phone_numbers",
    ),
    path(
    ...
    path(
        "confirm_hq_invite",
        views.ConfirmHQInviteCallback.as_view(),
        name="confirm_hq_invite",
    ),
]
