...
urlpatterns = [
    ...
    path("recover/complete_recovery", views.complete_recovery, name="complete_recovery"),
    ...
    path("fetch_user_analytics", views.FetchUserAnalytics.as_view(), name="fetch_user_analytics"),
    ...
    path("add_user_analytics", views.AddUserAnalytics.as_view(), name="add_user_analytics"),
]
